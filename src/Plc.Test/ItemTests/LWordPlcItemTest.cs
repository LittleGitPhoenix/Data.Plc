...
[TestFixture]
[Category("Item Test")]
public sealed class LWordPlcItemTest
{
	/// <summary>
	...
	{
		LWordPlcItem item = new PlcItemBuilder()
	...
	{
		// Arrange
		var item = new LWordPlcItem(0, 0, TargetValue);
	...
	public void Check_Initial_Data()
	{
		...
		var targetData = DataConverter.ToBytes(targetValue, LWordPlcItem.Endianness);
