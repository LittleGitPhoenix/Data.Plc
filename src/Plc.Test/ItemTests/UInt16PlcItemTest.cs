...
[TestFixture]
[Category("Item Test")]
public sealed class UInt16PlcItemTest
{
	/// <summary>
	...
	{
		UInt16PlcItem item = new PlcItemBuilder()
	...
	{
		// Arrange
		var item = new UInt16PlcItem(0, 0, TargetValue);
	...
	public void Check_Initial_Data()
	{
		...
		var targetData = DataConverter.ToBytes(targetValue, UInt16PlcItem.Endianness);
	...
	public void Check_ToData()
	{
		...
		var targetValue = TargetValue;
		var targetData = DataConverter.ToBytes(targetValue, UInt16PlcItem.Endianness);
		var item = new UInt16PlcItem(0, 0);
