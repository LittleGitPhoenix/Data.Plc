...
[TestFixture]
[Category("Item Test")]
public sealed class UInt32PlcItemTest
{
	/// <summary>
	...
	{
		UInt32PlcItem item = new PlcItemBuilder()
	...
	{
		// Arrange
		var item = new UInt32PlcItem(0, 0, TargetValue);
	...
	public void Check_Initial_Data()
	{
		...
		var targetData = DataConverter.ToBytes(targetValue, UInt32PlcItem.Endianness);
	...
	public void Check_ToData()
	{
		...
		var targetValue = TargetValue;
		var targetData = DataConverter.ToBytes(targetValue, UInt32PlcItem.Endianness);
		var item = new UInt32PlcItem(0, 0);
